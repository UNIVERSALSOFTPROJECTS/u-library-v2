<script>
    ...
    let bannerDefault = [{"url_w":"https://d1dkqs4jlldj3s.cloudfront.net/Latinsport21/bn_w_caballos2.png","url_m":"https://assets.apiusoft.com/Latinsport21/bn_m_caballos.png","dateFrom": "","dateUntil": "","category":"horses"}];
    let bannersJSON = [];
    let filteredBanners = [];
