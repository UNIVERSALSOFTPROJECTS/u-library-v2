<script>
    ...
    let bannerDefault = [{"url_w":"https://assets-usoft.universalsoft.net/Latinsport21/bn_w_caballos2.png","url_m":"https://assets-usoft.universalsoft.net/Latinsport21/bn_m_caballos.png","dateFrom": "","dateUntil": "","category":"horses"}];
    let bannersJSON = [];
    let filteredBanners = [];
