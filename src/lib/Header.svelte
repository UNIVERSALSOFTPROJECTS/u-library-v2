<script>
    ...
    const configDeposit = {
        ...
        banksOrigin:[
            ...
            { id: 4, name: "Banco Venezolano de Crédito (BVC)" },
            { id: 5, name: "Banco Mercantil" },
            { id: 8, name: "Banco Provincial (BBVA)" },
            { id: 14, name: "Bancaribe" },
            { id: 115, name: "Banco Exterior" },
            { id: 128, name: "Banco Caroní" },
            { id: 134, name: "Banesco Banco Universal" },
            { id: 137, name: "Banco Sofitasa" },
            { id: 138, name: "Banco Plaza" },
            { id: 146, name: "Bangente" },
            { id: 151, name: "Banco Fondo Común (BFC)" },
            { id: 156, name: "100% Banco" },
            { id: 157, name: "Del Sur Banco Universal" },
            { id: 163, name: "Banco del Tesoro" },
            { id: 166, name: "Banco Agrícola de Venezuela" },
            { id: 168, name: "Bancrecer" },
            { id: 169, name: "Mi Banco" },
            { id: 171, name: "Banco Activo" },
            { id: 172, name: "Bancamiga" },
            { id: 174, name: "Banplus" },
            { id: 175, name: "Banco Bicentenario del Pueblo" },
            { id: 177, name: "Banco de la Fuerza Armada Nacional Bolivariana (BANFANB)" },
            { id: 191, name: "Banco Nacional de Crédito (BNC)" }
        ]
    };
    //  const configWithdrawal = {
    //     dataType : "",
