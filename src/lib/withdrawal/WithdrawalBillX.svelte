...
<div class="modal-body {pendingWithdrawal && pendingWithdrawal.monto>0?'':'noPending'}">
    {#if loadWithdrawal}
        ...
        {#if pendingWithdrawal && pendingWithdrawal.monto>0}
            <img class="logo" src="https://assets-usoft.universalsoft.net/crashgames/logo.png" alt="">
            <b>Pago de retiro</b>
            ...
            <img class="barcode" src="https://assets-usoft.universalsoft.net/generic_imgs/utils/barcode.webp" alt="">
        {:else}
