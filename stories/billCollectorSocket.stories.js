import BillCollectorSocket from '../src/lib/payments/BillCollectorSocket.svelte';
...
export default {
  title: 'BillCollector',
  component: BillCollectorSocket, 
};


export const BillCollectorWithUser = () => ({
  Component: BillCollectorSocket,
  props: {user}
});

export const BillCollectorNoUser = () => ({
  Component: BillCollectorSocket,
  props: {user:null}
});
